...
JOBDIR=../networks/sten_1_contralateral
...
#    sleep 120 #60
    ...
    snudda input ${JOBDIR} --parallel --time 18 --input input_contralateral.json --networkFile ${JOBDIR}/network-synapses-minimal.hdf5
