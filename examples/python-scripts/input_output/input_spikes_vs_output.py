...
experiment_config_file_high=os.path.join("..","..","..","snudda","data","input_config","spk_input_vs_out.json")
...
#exp_proto['iSPN']["CorticalSignal"]["frequency"] = (np.arange(1, 4, 1)).tolist()
exp_proto['iSPN']["CorticalSignal"]["frequency"] = np.linspace(min_freq, max_freq, n_steps).tolist()
...
#Create PD0 "network"
###################################################################
network_name_pd0="inpspk_vs_output_03_pd0"
...
network_name_pd2="inpspk_vs_output_03_pd2"
