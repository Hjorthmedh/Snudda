...
if [ $SLURM_PROCID -gt 0 ]; then
    ...
    # echo ">>> Init: "`date`
    # The init is done in the job-file for this code, since we want
    # FS only, and need to make sure we have correct FS density
    ...
    snudda input ${JOBDIR} --parallel --time 15
