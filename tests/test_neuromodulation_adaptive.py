...
class TestNeuromodulationAdaptive(unittest.TestCase):
    ...
    def setUp(self):
        ...
        cnc.define_striatum_neuromodulation(num_dSPN=5, num_iSPN=5, num_ChIN=1, volume_type="cube", neurons_dir=args.neurons_dir)
    ...
    def test_neuromodulation_adaptive(self):
        ...
        args.time = 0.01
        args.nrnivmodl = os.path.join(os.environ["SNUDDA_DATA"], "mechanisms-ptr", "da_ach")
        if os.path.exists("da_ach"):
            pass
        else:
