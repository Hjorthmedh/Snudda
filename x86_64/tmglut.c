...
#define mg _p[13]
#define damod _p[14]
#define maxModNMDA _p[15]
#define maxModAMPA _p[16]
#define use_stp _p[17]
#define failRate _p[18]
#define i _p[19]
#define i_ampa _p[20]
#define i_nmda _p[21]
#define g _p[22]
...
#define B_nmda _p[28]
#define ical _p[29]
#define ical_ampa _p[30]
#define ical_nmda _p[31]
...
extern "C" {
 ...
 static double _hoc_modAMPA();
 static double _hoc_modNMDA();
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "modAMPA", _hoc_modAMPA,
 "modNMDA", _hoc_modNMDA,
 "urand", _hoc_urand,
 0, 0
};
#define modAMPA modAMPA_tmGlut
#define modNMDA modNMDA_tmGlut
#define urand urand_tmGlut
 extern double modAMPA( _threadargsproto_ );
 extern double modNMDA( _threadargsproto_ );
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 tmGlut /home/akozlov/doc/hbp-bsp-live-papers-dev-priv/2020/hjorth_et_al_2020/work/Snudda/x86_64/tmglut.mod\n");
...
double modAMPA ( _threadargsproto_ ) {
   double _lmodAMPA;
 _lmodAMPA = 1.0 + damod * ( maxModAMPA - 1.0 ) ;
   
return _lmodAMPA;
 }
 
static double _hoc_modAMPA(void* _vptr) {
 double _r;
   double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt;
   _p = ((Point_process*)_vptr)->_prop->param;
  _ppvar = ((Point_process*)_vptr)->_prop->dparam;
  _thread = _extcall_thread;
  _nt = (_NrnThread*)((Point_process*)_vptr)->_vnt;
 _r =  modAMPA ( _p, _ppvar, _thread, _nt );
 return(_r);
}
 
double modNMDA ( _threadargsproto_ ) {
   double _lmodNMDA;
 _lmodNMDA = 1.0 + damod * ( maxModNMDA - 1.0 ) ;
   
return _lmodNMDA;
 }
 
static double _hoc_modNMDA(void* _vptr) {
 double _r;
   double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt;
   _p = ((Point_process*)_vptr)->_prop->param;
  _ppvar = ((Point_process*)_vptr)->_prop->dparam;
  _thread = _extcall_thread;
  _nt = (_NrnThread*)((Point_process*)_vptr)->_vnt;
 _r =  modNMDA ( _p, _ppvar, _thread, _nt );
 return(_r);
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/akozlov/doc/hbp-bsp-live-papers-dev-priv/2020/hjorth_et_al_2020/work/Snudda/snudda/data/cellspecs/mechanisms/tmglut.mod";
static const char* nmodl_file_text = 
