...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 cap_ch /home/akozlov/doc/hbp-bsp-live-papers-dev-priv/2020/hjorth_et_al_2020/work/Snudda/x86_64/cap_ch.mod\n");
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   g = ( 1e3 ) * gbar * m * modulation ( _threadargs_ ) ;
 ...
 v=_v;
{
  ...
  cao = _ion_cao;
 { error =  states();
 if(error){fprintf(stderr,"at line 73 in file cap_ch.mod:\n     SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/akozlov/doc/hbp-bsp-live-papers-dev-priv/2020/hjorth_et_al_2020/work/Snudda/snudda/data/cellspecs/mechanisms/cap_ch.mod";
static const char* nmodl_file_text = 
