...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kv4_ch /home/akozlov/doc/hbp-bsp-live-papers-dev-priv/2020/hjorth_et_al_2020/work/Snudda/x86_64/kv4_ch.mod\n");
 ...
 t = 0.0;
{
 ...
 if(error){fprintf(stderr,"at line 95 in file kv4_ch.mod:\n	SOLVE kin STEADYSTATE sparse\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 11; ++_i) {
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   g = gbar * o * modulation ( _threadargs_ ) ;
   ik = g * ( v - ek ) ;
   }
 _current += ik;
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 89 in file kv4_ch.mod:\n	SOLVE kin METHOD sparse\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 11; ++_i) {
      _p[_slist1[_i]] += dt*_p[_dlist1[_i]];
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/akozlov/doc/hbp-bsp-live-papers-dev-priv/2020/hjorth_et_al_2020/work/Snudda/snudda/data/cellspecs/mechanisms/kv4_ch.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  "c1 - c2 - c3 - c4 - o\n"
