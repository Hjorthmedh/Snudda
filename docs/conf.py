...
autodoc_mock_imports = ['mpi4py', 'neuron', 'neuron.rxd', 'bluepyopt', 'bluepyopt.ephys', 'bluepyopt.ephys.simulators', 'ipyparallel', 'matplotlib', 'h5py', 'numpy', 'scipy', 'scipy.spatial', 'scipy.sparse', 'sonata', 'pyzmq', 'numexpr', 'argparse', 'pyswarms', 'numba', "setuptools", "psutil", "cython", "wheel", "vedo", "ruamel.yaml", "quantities", "plotly_plots"]
