...
MOCK_MODULES = ['mpi4py', 'NEURON', 'bluepyopt', 'bluepyopt.ephys', 'ipyparallel', 'matplotlib', 'matplotlib.pyplot', 'h5py', 'numpy', 'scipy', 'scipy.cluster', 'sonata', 'pyzmq', 'numexpr', 'argparse', 'pyswarms', 'numba']
