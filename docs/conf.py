...
MOCK_MODULES = ['mpi4py', 'NEURON', 'bluepyopt', 'bluepyopt.ephys', 'ipyparallel', 'matplotlib', 'matplotlib.pyplot', 'h5py', 'numpy', 'scipy', 'sonata', 'pyzmq', 'numexpr', 'argparse', 'pyswarms', 'numba']
