...
class AnalyseSynapseLocation:
    ...
    def plot_synapse_distance_to_soma(self, pre_type=None, post_type=None, fig_path=None, bin_width=20, figure=None,
                                      label=None, title=None, show_plot=True):
        ...
        plt.hist(dist_scaled, bins=bins, label=label, histtype="step")
        if title is None:
