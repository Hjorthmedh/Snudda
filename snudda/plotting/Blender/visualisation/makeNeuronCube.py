...
# Does this work?
#bpy.ops.wm.save_as_mainfile(filepath="neuronCubeWithMorph.blend")

if(False):
  bpy.ops.render.render()
  bpy.data.images['Render Result'].save_render(filepath="cube-of-neurons-with-neurites-2174.png")
